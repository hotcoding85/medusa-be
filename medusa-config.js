...
const plugins = [
  ...
  // },
  {
    ...
    options: {
      ...
      config: {
        // host: "https://ms-c97b88dc3c89-142.saas.meili.dev",
        // apiKey: "2b53060fad07dbcb061cec080a14c52fb1ba848c",
      ...
      settings: {
        ...
        products: {
          ...
          filterableAttributes: ["rating", "brand", "category", "price", "tag"],
          displayedAttributes: [
            "title",
            "description",
            "id",
...
module.exports = {
  projectConfig: {
    // redis_url: REDIS_URL,
    // For more production-like environment install PostgresQL
    database_url: "postgres://localhost/medusa__store",
    database_type: "postgres",
    store_cors: STORE_CORS,
    admin_cors: ADMIN_CORS,
  },
